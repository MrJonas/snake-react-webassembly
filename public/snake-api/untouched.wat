(module
 ...
 (global $assembly/direction/DIRECTION.LEFT i32 (i32.const 4))
 (global $assembly/direction/isOpposite i32 (i32.const 32))
 (global $assembly/snake/MAX_Y i32 (i32.const 25))
 (global $assembly/snake/MAX_X i32 (i32.const 25))
 (global $assembly/constants/MAX_Y i32 (i32.const 25))
 (global $assembly/constants/MAX_X i32 (i32.const 25))
 ...
 (export "setDirection" (func $assembly/index/setDirection))
 ...
 (start $~start)
 (func $start:assembly/direction~anonymous|0 (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  global.get $assembly/direction/DIRECTION.UP
  i32.eq
  if (result i32)
   local.get $1
   global.get $assembly/direction/DIRECTION.DOWN
   i32.eq
  else
   i32.const 0
  end
  ...
  if (result i32)
   ...
   local.get $0
   global.get $assembly/direction/DIRECTION.RIGHT
   i32.eq
   if (result i32)
    local.get $1
    global.get $assembly/direction/DIRECTION.LEFT
    i32.eq
   else
    i32.const 0
   end
 ...
 (func $assembly/cell/Cell#set:x (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
 )
 (func $assembly/cell/Cell#set:y (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
 )
 (func $~lib/array/Array<assembly/cell/Cell>#get:length (param $0 i32) (result i32)
  local.get $0
  i32.load offset=12
 )
 (func $assembly/cell/Cell#isSame (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.load
  local.get $1
  i32.load
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#set:length_ (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=12
 )
 (func $~lib/array/Array<assembly/cell/Cell>#push (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
  ...
  local.get $0
  local.get $3
  call $~lib/array/Array<assembly/cell/Cell>#set:length_
  local.get $3
 )
 ...
 (func $assembly/game/Game#set:food (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
  local.get $0
 ...
 (func $assembly/game/Game#set:snake (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#__uset (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  i32.load offset=4
  local.get $1
  i32.const 2
 ...
 (func $assembly/snake/Snake#set:body (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/snake/Snake#set:direction (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
 )
 (func $assembly/snake/Snake#reset (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  ...
  i32.const 4
  i32.const 12
  call $assembly/cell/Cell#constructor
  call $~lib/array/Array<assembly/cell/Cell>#__uset
  local.get $1
  i32.const 1
  i32.const 0
  i32.const 3
  ...
  call $~lib/array/Array<assembly/cell/Cell>#__uset
  local.get $1
  call $assembly/snake/Snake#set:body
  local.get $0
  global.get $assembly/direction/DIRECTION.RIGHT
  call $assembly/snake/Snake#set:direction
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#unshift (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $assembly/game/Game#setDirection (param $0 i32) (param $1 i32)
  local.get $0
  i32.load
  local.get $1
  call $assembly/snake/Snake#set:direction
 ...
 (func $~lib/function/Function<%28i32%2Ci32%29=>bool>#__visit (param $0 i32) (param $1 i32)
  local.get $0
  i32.load offset=4
  local.get $1
  call $~lib/rt/itcms/__visit
 )
 (func $~lib/function/Function<%28i32%2Ci32%29=>bool>~visit (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $~lib/function/Function<%28i32%2Ci32%29=>bool>#__visit
 )
 ...
 (func $assembly/snake/Snake~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.tee $2
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#__visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<assembly/cell/Cell>~visit (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $~lib/array/Array<assembly/cell/Cell>#__visit
 )
  ...
  block $invalid
   block $~lib/array/Array<~lib/array/Array<i32>>
    block $~lib/array/Array<i32>
     block $~lib/array/Array<assembly/cell/Cell>
      block $assembly/cell/Cell
       block $assembly/snake/Snake
        block $assembly/game/Game
         block $~lib/function/Function<%28i32%2Ci32%29=>bool>
          block $~lib/arraybuffer/ArrayBufferView
           block $~lib/string/String
            block $~lib/arraybuffer/ArrayBuffer
             ...
             i32.sub
             i32.load
             br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/function/Function<%28i32%2Ci32%29=>bool> $assembly/game/Game $assembly/snake/Snake $assembly/cell/Cell $~lib/array/Array<assembly/cell/Cell> $~lib/array/Array<i32> $~lib/array/Array<~lib/array/Array<i32>> $invalid
            end
            return
           end
           return
         ...
         local.get $0
         local.get $1
         call $~lib/function/Function<%28i32%2Ci32%29=>bool>~visit
         return
        end
        local.get $0
        local.get $1
       ...
       local.get $0
       local.get $1
       call $assembly/snake/Snake~visit
       return
      end
      return
     end
     local.get $0
     local.get $1
     call $~lib/array/Array<assembly/cell/Cell>~visit
     return
    end
    local.get $0
    local.get $1
 ...
 (func $assembly/snake/Snake#isOverlaping (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  loop $for-loop|0
   ...
   i32.store
   local.get $5
   call $~lib/array/Array<assembly/cell/Cell>#get:length
   i32.lt_s
   local.set $3
   local.get $3
   if
    ...
    local.get $5
    local.get $2
    call $~lib/array/Array<assembly/cell/Cell>#__get
    local.tee $4
    i32.store offset=4
    local.get $4
    local.get $1
    call $assembly/cell/Cell#isSame
    if
     i32.const 1
     local.set $5
     global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/game/Game#generateFood (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  loop $for-loop|0
   local.get $1
   global.get $assembly/constants/MAX_X
   i32.lt_s
   local.set $3
   local.get $3
   if
    ...
    loop $for-loop|1
     local.get $4
     global.get $assembly/constants/MAX_Y
     i32.lt_s
     local.set $5
     local.get $5
     if
      ...
      local.get $8
      local.get $6
      call $assembly/snake/Snake#isOverlaping
      i32.eqz
      if
       local.get $2
       local.get $6
       call $~lib/array/Array<assembly/cell/Cell>#push
       drop
      end
      local.get $4
      i32.const 1
  ...
  i32.trunc_f32_s
  call $~lib/array/Array<assembly/cell/Cell>#__get
  call $assembly/game/Game#set:food
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $assembly/snake/Snake#grow (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  ...
  global.get $~lib/memory/__stack_pointer
  local.get $0
  call $assembly/snake/Snake#getNextHead
  local.tee $1
  i32.store
  local.get $0
  i32.load
  ...
  local.get $2
  local.get $1
  call $~lib/array/Array<assembly/cell/Cell>#unshift
  drop
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
 ...
 (func $assembly/snake/Snake#move (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  ...
  if
   ...
   i32.store offset=4
   local.get $2
   call $~lib/array/Array<assembly/cell/Cell>#pop
   drop
  end
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/game/Game#updatePosition (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  ...
  if
   ...
   i32.store
   local.get $2
   call $assembly/snake/Snake#move
  end
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.add
 ...
 (func $assembly/snake/Snake#getCordinates (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    i32.store offset=4
    local.get $5
    call $assembly/cell/Cell#getCordinates
    local.tee $4
    i32.store offset=12
    local.get $2
    local.get $4
 ...
 (func $assembly/game/Game#getCoordinates (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  ...
  i32.store offset=8
  local.get $3
  call $assembly/snake/Snake#getCordinates
 ...
 (func $assembly/index/getPosition (result i32)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $assembly/game/Game#updatePosition
  global.get $assembly/index/game
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
  i32.store
  local.get $0
  call $assembly/game/Game#getCoordinates
  local.set $0
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $assembly/index/setDirection (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  global.get $assembly/direction/isOpposite
  i32.load
  ...
  if
   ...
   local.get $1
   local.get $0
   call $assembly/game/Game#setDirection
   i32.const 1
   local.set $1
   global.get $~lib/memory/__stack_pointer
   i32.const 4
 ...
 (func $assembly/cell/Cell#constructor (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  i32.const 0
  call $assembly/cell/Cell#set:x
  local.get $0
  i32.const 0
  call $assembly/cell/Cell#set:y
  local.get $0
  local.get $1
  call $assembly/cell/Cell#set:x
  local.get $0
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#__get (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $assembly/game/Game#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  call $assembly/game/Game#set:snake
  local.get $0
  i32.const 0
  i32.const 0
  i32.const 0
 ...
 (func $assembly/snake/Snake#getNextHead (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  if
   local.get $2
   global.get $assembly/snake/MAX_Y
   i32.const 1
   i32.sub
   i32.ge_s
   if (result i32)
   ...
   if
    ...
    if
     ...
     i32.le_s
     if (result i32)
      global.get $assembly/snake/MAX_X
      i32.const 1
      i32.sub
     else
      local.get $3
 ...
 (func $~lib/array/Array<assembly/cell/Cell>#pop (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/cell/Cell#getCordinates (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
